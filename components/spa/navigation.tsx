  ...
  return (
    ...
    >
      <div className="max-w-[1600px] mx-auto px-4 lg:px-8">
        ...
        {/* Mobile Navigation */}
        {isOpen && (
          <div className={`lg:hidden absolute top-full left-0 right-0 h-auto max-h-[85vh] p-6 backdrop-blur-xl transition-colors duration-300 shadow-lg overflow-y-auto pb-10 ${isSolid
            ? "bg-white"
            : "bg-black/95"
            }`}>
            <div className="flex flex-col gap-6">
              ...
              <Link
                href="#booking"
                onClick={() => setIsOpen(false)}
                className={`inline-block w-full text-center border px-8 py-3 transition-colors duration-300 text-sm font-medium tracking-wide ${isSolid
                  ? "border-black text-black hover:bg-black hover:text-white"
                  : "border-white text-white hover:bg-white hover:text-black"
                  }`}
              >
